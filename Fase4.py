...
def abrir_arbol_binario(parent=None):
    if parent:
        arbol_binario_ventana = tk.Toplevel(parent)
    else:
    ...
    if not isinstance(arbol_binario_ventana, tk.Toplevel):
        arbol_binario_ventana.mainloop()
    return arbol_binario_ventana